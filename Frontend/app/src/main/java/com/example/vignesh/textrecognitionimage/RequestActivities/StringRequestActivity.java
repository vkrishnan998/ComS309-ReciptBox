package com.example.vignesh.textrecognitionimage.RequestActivities;
...
public class StringRequestActivity extends Activity {
    ...
    private void makeStringReq() {
        ...
        StringRequest strReq = new StringRequest(Method.POST, Const.URL_STRING_REQ, new Response.Listener<String>() {
            @Override
